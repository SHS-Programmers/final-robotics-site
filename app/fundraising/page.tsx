                ...
                return (
                    <div className="flex justify-center items-center min-h-screen bg-gray-900 text-gray-300">
                        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                            <div className="bg-gray-800 bg-opacity-80 p-8 rounded-lg shadow-lg max-w-lg w-full order-2 md:order-1">
                                ...
                                <strong className="block mb-4">
                                    ...
                                    Please do{" "}
                                    <Link href="/contact">
                                        <span className="text-green-400 underline hover:text-green-300">contact</span>
                                    </Link>{" "}
                                    us if you would like to donate to our robotics program.
                                </strong>
