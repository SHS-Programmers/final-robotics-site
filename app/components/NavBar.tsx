...
import { usePathname } from "next/navigation"; // For highlighting the current page
    ...
    return (
        <div className="fixed z-50 top-2 left-5 right-5 flex justify-between items-center frosted-glass px-6 py-3">
            ...
            <div className="flex items-center text-white font-jockey text-2xl font-bold space-x-4">
                <Image src={logo} width={500} height={500} alt="Staley Millennium Falcons Logo" className="h-10 w-auto rounded-xl shadow-lg" />
